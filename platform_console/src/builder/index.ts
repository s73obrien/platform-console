...
import {
  ...
  BuilderOutput,
  createBuilder,
} from '../../devkit/architect/src';
import { BuildResult, WebpackLoggingCallback, runWebpack } from '../../devkit/build_webpack/src';
import {
  experimental,
  getSystemPath,
  join,
...
import { NgBuildAnalyticsPlugin } from '../../devkit/build_angular/plugins/webpack/analytics';
import { WebpackConfigOptions } from '../../devkit/build_angular/src/angular-cli-files/models/build-options';
import {
  getAotConfig,
  getBrowserConfig,
  getCommonConfig,
  ...
  getStylesConfig,
  getWorkerConfig,
} from '../../devkit/build_angular/src/angular-cli-files/models/webpack-configs';
import { writeIndexHtml } from '../../devkit/build_angular/src/angular-cli-files/utilities/index-file/write-index-html';
import { readTsconfig } from '../../devkit/build_angular/src/angular-cli-files/utilities/read-tsconfig';
import { augmentAppWithServiceWorker } from '../../devkit/build_angular/src/angular-cli-files/utilities/service-worker';
import {
  statsErrorsToString,
  statsToString,
  statsWarningsToString,
} from '../../devkit/build_angular/src/angular-cli-files/utilities/stats';
import { ExecutionTransformer } from '../../devkit/build_angular/src/transforms';
import { deleteOutputDir, isEs5SupportNeeded } from '../../devkit/build_angular/src/utils';
import { Version } from '../../devkit/build_angular/src/utils/version';
import { generateBrowserWebpackConfigFromContext } from '../../devkit/build_angular/src/utils/webpack-browser-config';
import { ConsoleBuilderOptions } from './schema';

export type ConsoleBuilderOutput = json.JsonObject & BuilderOutput & {
  outputPath: string;
};
  ...
  return from(initialize(options, context, host, transforms.webpackConfiguration)).pipe(
    switchMap(({ workspace, config: configs }) => {
      ...
      return from(configs).pipe(
        ...
        } as ConsoleBuilderOutput)),
      );
    }),
  );
}

export default createBuilder<json.JsonObject & ConsoleBuilderOptions>(buildWebpackBrowser);
