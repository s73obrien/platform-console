...
import { ConsoleBuilderSchema } from './console.builder.schema';
...
// import { BuildResult, WebpackLoggingCallback, WebpackBuilder } from '@angular-devkit/build-webpack';
...
export default class ConsoleBuilder implements Builder<ConsoleBuilderSchema> {
  constructor(private context: BuilderContext) { }

  run(builderConfig: BuilderConfiguration<Partial<ConsoleBuilderSchema>>): Observable<BuildEvent> {
          ...
          return from(configs).pipe(
            ...
            mergeScan((lastResult, config) => {
              ...
              if (lastResult.success) {
                return (new WebpackBuilder(context)).runWebpack(config, loggingFn);
              } else {
                return of();
              }
